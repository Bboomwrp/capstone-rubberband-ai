...
public class DefaultOptionsScreen : OptionsScreen{
    ...
    public InputField maxRoundInput;
	#endregion
	...
	public override void OnShow (){
        ...
        if (this.maxRoundInput != null)
        {
            this.maxRoundInput.text = UFE.config.roundOptions.totalRounds.ToString();
        }
    ...
    public virtual void SetMaxRound(InputField inputField)
    {
        if (this.visible)
        {
            int value;
            ...
            {
                Debug.LogError("Round must be integer.");
            }
        }
    }
	#endregion
