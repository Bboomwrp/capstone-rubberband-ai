...
//        print("in test collision");
		foreach (HitBox hitBox in hitBoxes) {
//            print("hitbox : " + hitBox.bodyPart + " state : " + hitBox.hide);
...
//            foreach (HitBox hitBox in hitBoxes)
//            {
//                if (hitBox.bodyPart == invHitBox.bodyPart) hitBox.hide = hide;
//            }
//            int indexPos = Array.IndexOf(hitBoxes, invHitBox.bodyPart);
            int indexPos = Array.FindIndex(hitBoxes, x => x.bodyPart == invHitBox.bodyPart);
//            print("index of " + invHitBox.bodyPart + " is " + indexPos);
            if (indexPos > -1)
            {
                hitBoxes[indexPos].hide = hide;
            }
        }
    }
