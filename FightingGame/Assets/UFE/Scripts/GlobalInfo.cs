...
public class TrainingModeOptions {
    ...
    public float p1StartingUltraGauge = 0f;
    public float p2StartingUltraGauge = 0f;
    public LifeBarTrainingMode p1Life;
    public LifeBarTrainingMode p1Gauge;
    public LifeBarTrainingMode p1UltraGauge;
    public LifeBarTrainingMode p1StunGauge;
    public LifeBarTrainingMode p2Life;
    public LifeBarTrainingMode p2Gauge;
    public LifeBarTrainingMode p2UltraGauge;
    public LifeBarTrainingMode p2StunGauge;
...
public class ComboOptions {
    ...
    public float hitStunDeteriorationVal;
    public Sizes damageDeterioration;
    public float damageDeteriorationVal;
    public Sizes airJuggleDeterioration;
    public float airJuggleDeteriorationVal;
...
public class GameGUI{
    ...
    public bool hasUltraGauge = true;
    public bool hasStunGauge = true;
...
public class GlobalInfo: ScriptableObject {
    ...
    public float stunStandupTime = 1.5f;
    public float stunDelayStartTime = 2f;
    public float stunDecreaseSpeed = 10f;
