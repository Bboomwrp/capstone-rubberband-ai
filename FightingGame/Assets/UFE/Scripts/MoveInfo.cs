...
public class Projectile: ICloneable {
    ...
    public float spaceBetweenHitsVal;
    ...
    public float damageOnHitFirst;
    public float damageOnBlockFirst;
    public float stunDamageFirst;
    public float damageOnHit;
	public float damageOnBlock;
    public float stunDamage;
    public float damageOnHitLast;
    public float damageOnBlockLast;
    public float stunDamageLast;
...
public class Hit: ICloneable {
    ...
    public bool cancelProjectile = false;
    ...
    public bool overrideOnlyOnAirHit = false;
    ...
    public Vector2 appliedForceAir;
...
public class MoveInfo: ScriptableObject {
    ...
    // Ultra
    public bool useUltraGauge;
    public bool isUltraMove;
