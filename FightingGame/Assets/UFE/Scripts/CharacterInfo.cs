...
public class MoveSetData: ICloneable {
    ...
    public MoveInfo[] stunnedMove = new MoveInfo[1];
...
public class CharacterInfo: ScriptableObject {
    ...
    public int maxUltraGauge;
    public int maxStunPoints = 1000;
    ...
    public float currentUltraGaugePoints { get; set; }
    public float currentStunPoints { get; set; }
