			...
			EditorGUILayout.BeginVertical(rootGroupStyle);{
				EditorGUILayout.BeginHorizontal();{
					...
					EditorGUILayout.BeginVertical();{
                        ...
                        characterInfo.maxUltraGauge = EditorGUILayout.IntField("Max Ultra Gauge:", characterInfo.maxUltraGauge);
                        characterInfo.maxStunPoints = EditorGUILayout.IntField("Stun Points:", characterInfo.maxStunPoints);
                    }
                    EditorGUILayout.EndVertical();
				...
				if (physicsOption){
					EditorGUILayout.BeginVertical(subGroupStyle);{
						...
						EditorGUI.BeginDisabledGroup(!characterInfo.physics.canJump);
                        {
                            ...
                            if (characterInfo.physics.pressureSensitiveJump) characterInfo.physics.minJumpForce = EditorGUILayout.FloatField("Min. Jump Force:", characterInfo.physics.minJumpForce);
...
#if UFE_BASIC               
                           EditorGUILayout.BeginVertical(subArrayElementStyle); {
                               EditorGUILayout.LabelField("Mecanim not supported on UFE Basic.");
                           } EditorGUILayout.EndVertical();
#else
								...
								if (characterInfo.moves[i].basicMovesToggle){
									EditorGUILayout.BeginVertical(subGroupStyle);{
                                        ...
                                        EditorGUILayout.BeginVertical(subArrayElementStyle);
                                        {
                                            ...
                                            EditorGUILayout.BeginHorizontal();
                                            {
                                                characterInfo.moves[i].stunnedMove[0] = (MoveInfo)EditorGUILayout.ObjectField("Move File:", characterInfo.moves[i].stunnedMove[0], typeof(MoveInfo), false);
                                            }
                                            EditorGUILayout.EndHorizontal();
                                            EditorGUIUtility.labelWidth = 150;
                                            ...
                                            {
                                                MoveEditorWindow.sentMoveInfo = characterInfo.moves[i].stunnedMove[0];
                                        ...
                                        //                                        MoveAsset
                                        //                                        basicMoveBlock("Stun (*)", characterInfo.moves[i].basicMoves.stunned, WrapMode.Loop, false, true, false, false, false);
                                        ...
                                        EditorGUI.BeginDisabledGroup(!characterInfo.moves[i].basicMoves.crouchEnabled);{
                                            basicMoveBlock("Crouching (*)", characterInfo.moves[i].basicMoves.crouching, WrapMode.Loop, false, true, false, false, false);
                                        } EditorGUI.EndDisabledGroup();
                                        EditorGUILayout.Space();
                                        
                                        if (characterInfo.moves[i].basicMoves.jumpEnabled){
                                            SubGroupTitle("Jump Animations");
                                            basicMoveBlock("Take Off", characterInfo.moves[i].basicMoves.takeOff, WrapMode.ClampForever, true, true, false, true, false);
                                            basicMoveBlock("Jump Straight (*)", characterInfo.moves[i].basicMoves.jumpStraight, WrapMode.ClampForever, true, true, false, false, false);
                                            basicMoveBlock("Jump Back", characterInfo.moves[i].basicMoves.jumpBack, WrapMode.ClampForever, true, true, false, false, false);
                                            basicMoveBlock("Jump Forward", characterInfo.moves[i].basicMoves.jumpForward, WrapMode.ClampForever, true, true, false, false, false);
                                            EditorGUILayout.Space();

                                            SubGroupTitle("Fall Animations");
                                            basicMoveBlock("Fall Straight (*)", characterInfo.moves[i].basicMoves.fallStraight, WrapMode.ClampForever, true, true, false, false, false);
                                            basicMoveBlock("Fall Back", characterInfo.moves[i].basicMoves.fallBack, WrapMode.ClampForever, true, true, false, false, false);
                                            basicMoveBlock("Fall Forward", characterInfo.moves[i].basicMoves.fallForward, WrapMode.ClampForever, true, true, false, false, false);
                                            basicMoveBlock("Landing", characterInfo.moves[i].basicMoves.landing, WrapMode.Once, true, true, false, false, false);
                                            EditorGUILayout.Space();
                                        };
                                        
                                        if (characterInfo.moves[i].basicMoves.blockEnabled){
                                            SubGroupTitle("Block Animations");
                                            basicMoveBlock("Standing Pose", characterInfo.moves[i].basicMoves.blockingHighPose, WrapMode.ClampForever, false, true, false, false, false);
                                            basicMoveBlock("Standing High Hit", characterInfo.moves[i].basicMoves.blockingHighHit, WrapMode.Once, true, true, true, false, false);
                                            basicMoveBlock("Standing Low Hit", characterInfo.moves[i].basicMoves.blockingLowHit, WrapMode.Once, true, true, true, false, false);
                                            basicMoveBlock("Crouching Pose", characterInfo.moves[i].basicMoves.blockingCrouchingPose, WrapMode.ClampForever, false, true, false, false, false);
                                            basicMoveBlock("Crouching Hit", characterInfo.moves[i].basicMoves.blockingCrouchingHit, WrapMode.Once, true, true, true, false, false);
                                            basicMoveBlock("Air Pose", characterInfo.moves[i].basicMoves.blockingAirPose, WrapMode.ClampForever, false, true, false, false, false);
                                            basicMoveBlock("Air Hit", characterInfo.moves[i].basicMoves.blockingAirHit, WrapMode.Once, true, true, true, false, false);
                                            EditorGUILayout.Space();
                                        };
                                        
                                        if (characterInfo.moves[i].basicMoves.parryEnabled){
                                            SubGroupTitle("Parry Animations");
                                            basicMoveBlock("Standing High Hit", characterInfo.moves[i].basicMoves.parryHigh, WrapMode.Once, true, true, false, false, false);
                                            basicMoveBlock("Standing Low Hit", characterInfo.moves[i].basicMoves.parryLow, WrapMode.Once, true, true, false, false, false);
                                            basicMoveBlock("Crouching Hit", characterInfo.moves[i].basicMoves.parryCrouching, WrapMode.Once, true, true, false, false, false);
                                            basicMoveBlock("Air Hit", characterInfo.moves[i].basicMoves.parryAir, WrapMode.Once, true, true, false, false, false);
                                            EditorGUILayout.Space();
                                        };

                                        SubGroupTitle("Hit Reactions");
                                        basicMoveBlock("Standing High Hit (*)", characterInfo.moves[i].basicMoves.getHitHigh, WrapMode.Once, true, true, true, true, false);
                                        basicMoveBlock("Standing Low Hit", characterInfo.moves[i].basicMoves.getHitLow, WrapMode.Once, true, true, true, true, false);
                                        EditorGUI.BeginDisabledGroup(!characterInfo.moves[i].basicMoves.crouchEnabled);{
                                            basicMoveBlock("Crouching Hit (*)", characterInfo.moves[i].basicMoves.getHitCrouching, WrapMode.Once, true, true, true, true, false);
                                        } EditorGUI.EndDisabledGroup();
                                        basicMoveBlock("Air Juggle [Launcher]", characterInfo.moves[i].basicMoves.getHitAir, WrapMode.ClampForever, true, true, false, true, false);
                                        basicMoveBlock("Knock Back [Knockdown]", characterInfo.moves[i].basicMoves.getHitKnockBack, WrapMode.ClampForever, true, true, false, true, true);
                                        basicMoveBlock("Standing High Hit [Knockdown]", characterInfo.moves[i].basicMoves.getHitHighKnockdown, WrapMode.ClampForever, false, true, false, true, true);
                                        basicMoveBlock("Standing Mid Hit [Knockdown]", characterInfo.moves[i].basicMoves.getHitMidKnockdown, WrapMode.ClampForever, false, true, false, true, true);
                                        basicMoveBlock("Sweep [Knockdown]", characterInfo.moves[i].basicMoves.getHitSweep, WrapMode.ClampForever, false, true, false, true, true);
                                        basicMoveBlock("Crumple [Knockdown]", characterInfo.moves[i].basicMoves.getHitCrumple, WrapMode.ClampForever, true, true, false, true, true);
                                        EditorGUILayout.Space();

                                        SubGroupTitle("Stage Reactions");
                                        basicMoveBlock("Ground Bounce [Launcher]", characterInfo.moves[i].basicMoves.groundBounce, WrapMode.ClampForever, true, true, false, true, false);
                                        basicMoveBlock("Standing Wall Bounce", characterInfo.moves[i].basicMoves.standingWallBounce, WrapMode.ClampForever, false, true, false, true, false);
                                        basicMoveBlock("Standing Wall Bounce [Knockdown]", characterInfo.moves[i].basicMoves.standingWallBounceKnockdown, WrapMode.ClampForever, false, true, false, true, false);
                                        basicMoveBlock("Air Wall Bounce [Knockdown]", characterInfo.moves[i].basicMoves.airWallBounce, WrapMode.ClampForever, true, true, false, true, false);
                                        EditorGUILayout.Space();

                                        SubGroupTitle("Fall Down Reactions");
                                        basicMoveBlock("Default (*)", characterInfo.moves[i].basicMoves.fallDown, WrapMode.ClampForever, true, true, false, true, false);
                                        basicMoveBlock("From Air Juggle [Knockdown]", characterInfo.moves[i].basicMoves.fallingFromAirHit, WrapMode.ClampForever, true, true, false, true, false);
                                        basicMoveBlock("From Ground Bounce [Knockdown]", characterInfo.moves[i].basicMoves.fallingFromGroundBounce, WrapMode.ClampForever, true, true, false, true, false);
                                        basicMoveBlock("Air Recovery", characterInfo.moves[i].basicMoves.airRecovery, WrapMode.ClampForever, true, true, false, true, false);
                                        EditorGUILayout.Space();

                                        SubGroupTitle("Stand Up Animations");
                                        //basicMoveBlock("Down (*)", characterInfo.moves[i].basicMoves.fallDown, WrapMode.ClampForever, false, true, false, false, true);
                                        //basicMoveBlock("Stand Up (*)", characterInfo.moves[i].basicMoves.standUp, WrapMode.ClampForever, true, true, false, false, false);
                                        basicMoveBlock("Default (*)", characterInfo.moves[i].basicMoves.standUp, WrapMode.ClampForever, true, true, false, true, false);
                                        basicMoveBlock("From Air Juggle", characterInfo.moves[i].basicMoves.standUpFromAirHit, WrapMode.ClampForever, true, true, false, true, false);
                                        basicMoveBlock("From Knock Back", characterInfo.moves[i].basicMoves.standUpFromKnockBack, WrapMode.ClampForever, true, true, false, true, false);
                                        basicMoveBlock("From Standing High Hit", characterInfo.moves[i].basicMoves.standUpFromStandingHighHit, WrapMode.ClampForever, true, true, false, true, false);
                                        basicMoveBlock("From Standing Mid Hit", characterInfo.moves[i].basicMoves.standUpFromStandingMidHit, WrapMode.ClampForever, true, true, false, true, false);
                                        basicMoveBlock("From Sweep", characterInfo.moves[i].basicMoves.standUpFromSweep, WrapMode.ClampForever, true, true, false, true, false);
                                        basicMoveBlock("From Crumple", characterInfo.moves[i].basicMoves.standUpFromCrumple, WrapMode.ClampForever, true, true, false, true, false);
                                        basicMoveBlock("From Standing Wall Bounce", characterInfo.moves[i].basicMoves.standUpFromStandingWallBounce, WrapMode.ClampForever, true, true, false, true, false);
                                        basicMoveBlock("From Air Wall Bounce", characterInfo.moves[i].basicMoves.standUpFromAirWallBounce, WrapMode.ClampForever, true, true, false, true, false);
                                        basicMoveBlock("From Ground Bounce", characterInfo.moves[i].basicMoves.standUpFromGroundBounce, WrapMode.ClampForever, true, true, false, true, false);
        ...
        if (basicMove.editorToggle){
            EditorGUILayout.BeginVertical(subArrayElementStyle);
            {
                ...
                /*} else if (label == "Crouching (*)") {
                    ...
                    basicMove.clip1 = (AnimationClip)EditorGUILayout.ObjectField("Crouching:", basicMove.clip1, typeof(UnityEngine.AnimationClip), false);
                    EditorGUI.EndDisabledGroup();

                    basicMove.clip2 = (AnimationClip)EditorGUILayout.ObjectField("Crouched:", basicMove.clip2, typeof(UnityEngine.AnimationClip), false);

                    EditorGUI.BeginDisabledGroup(basicMove.overrideBlendingOut);
                    basicMove.clip3 = (AnimationClip)EditorGUILayout.ObjectField("Standing:", basicMove.clip3, typeof(UnityEngine.AnimationClip), false);
                    EditorGUI.EndDisabledGroup();*/
                ...
                basicMove.bpVisibleToggle = EditorGUILayout.Foldout(basicMove.bpVisibleToggle, "Visible Body Parts", foldStyle);
                if (basicMove.bpVisibleToggle)
                {
                    EditorGUILayout.BeginVertical(subGroupStyle);
                    {
                        EditorGUI.indentLevel += 1;
                        EditorGUIUtility.labelWidth = 180;
                        for (int i = 0; i < basicMove.bodyPartVisibilityChanges.Length; i++)
                        {
                            EditorGUILayout.Space();
                            EditorGUILayout.BeginVertical(arrayElementStyle);
                            {
                                ...
                                EditorGUILayout.BeginHorizontal();
                                {
                                    basicMove.bodyPartVisibilityChanges[i].bodyPart = (BodyPart)EditorGUILayout.EnumPopup("Body Part:", basicMove.bodyPartVisibilityChanges[i].bodyPart);
                                    if (GUILayout.Button("", "PaneOptions"))
                                    {
                                        PaneOptions<BodyPartVisibilityChange>(basicMove.bodyPartVisibilityChanges, basicMove.bodyPartVisibilityChanges[i], delegate (BodyPartVisibilityChange[] newElement) { basicMove.bodyPartVisibilityChanges = newElement; });
                                    }
                                }
                                EditorGUILayout.EndHorizontal();
                                basicMove.bodyPartVisibilityChanges[i].visible = EditorGUILayout.Toggle("Visible:", basicMove.bodyPartVisibilityChanges[i].visible);
                                basicMove.bodyPartVisibilityChanges[i].left = EditorGUILayout.Toggle("Trigger Left:", basicMove.bodyPartVisibilityChanges[i].left);
                                basicMove.bodyPartVisibilityChanges[i].right = EditorGUILayout.Toggle("Trigger Right:", basicMove.bodyPartVisibilityChanges[i].right);
                                basicMove.bodyPartVisibilityChanges[i].saveAsDefault = EditorGUILayout.Toggle("Save as Default:", basicMove.bodyPartVisibilityChanges[i].saveAsDefault);
                        ...
                        if (StyledButton("New Visibility Change"))
                            basicMove.bodyPartVisibilityChanges = AddElement<BodyPartVisibilityChange>(basicMove.bodyPartVisibilityChanges, new BodyPartVisibilityChange());
