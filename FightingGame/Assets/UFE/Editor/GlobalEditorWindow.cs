...
public class GlobalEditorWindow : EditorWindow {
	...
	public void OnGUI(){
				...
				if (roundOptions){
					EditorGUILayout.BeginVertical(subGroupStyle);{
                        ...
                        if (globalInfo.roundOptions.slowMotionKO) {
                            globalInfo.roundOptions.slowMoTimer = EditorGUILayout.FloatField("- Slow-mo Timer (seconds):", globalInfo.roundOptions.slowMoTimer);
                            globalInfo.roundOptions.slowMoSpeed = EditorGUILayout.Slider("- Game Speed:", globalInfo.roundOptions.slowMoSpeed, .01f, 1);
                        }
			...
			EditorGUILayout.BeginVertical(rootGroupStyle);{
				...
				if (comboOptions){
					EditorGUILayout.BeginVertical(subGroupStyle);{
                        ...
                        if (globalInfo.comboOptions.hitStunDeterioration == Sizes.Custom)
                            globalInfo.comboOptions.hitStunDeteriorationVal = EditorGUILayout.FloatField("- Deterioration Value:", globalInfo.comboOptions.hitStunDeteriorationVal);
                        ...
                        if (globalInfo.comboOptions.damageDeterioration == Sizes.Custom)
                            globalInfo.comboOptions.damageDeteriorationVal = EditorGUILayout.FloatField("- Deterioration Value:", globalInfo.comboOptions.damageDeteriorationVal);
                        ...
                        if (globalInfo.comboOptions.airJuggleDeterioration == Sizes.Custom)
                            globalInfo.comboOptions.airJuggleDeteriorationVal = EditorGUILayout.FloatField("- Deterioration Value:", globalInfo.comboOptions.airJuggleDeteriorationVal);
            ...
            EditorGUILayout.BeginVertical(rootGroupStyle);
            {
                ...
                if (bounceOptions) {
                    EditorGUILayout.BeginVertical(subGroupStyle);
                    {
                        ...
                        if (globalInfo.groundBounceOptions.bounceForce == Sizes.Custom)
                            globalInfo.groundBounceOptions.bounceForceVal = EditorGUILayout.FloatField("- Bounce Back Multiplier:", globalInfo.groundBounceOptions.bounceForceVal);
                        ...
                        EditorGUI.BeginDisabledGroup(globalInfo.groundBounceOptions.bounceForce == Sizes.None);
                        {
                            ...
                            globalInfo.groundBounceOptions.positionOffSet = EditorGUILayout.Vector3Field("Off Set (Position):", globalInfo.groundBounceOptions.positionOffSet);
                        ...
                        if (globalInfo.wallBounceOptions.bounceForce == Sizes.Custom)
                            globalInfo.wallBounceOptions.bounceForceVal = EditorGUILayout.FloatField("- Bounce Back Multiplier:", globalInfo.wallBounceOptions.bounceForceVal);
                        ...
                        EditorGUI.BeginDisabledGroup(globalInfo.wallBounceOptions.bounceForce == Sizes.None);
                        {
                            ...
                            globalInfo.wallBounceOptions.positionOffSet = EditorGUILayout.Vector3Field("Off Set (Position):", globalInfo.wallBounceOptions.positionOffSet);
			...
			EditorGUILayout.BeginVertical(rootGroupStyle);{
				...
				if (screenOptions){
					EditorGUILayout.BeginVertical(subGroupStyle);{
                        ...
                        globalInfo.gameGUI.roundFadeDuration = Mathf.Max(0f, EditorGUILayout.FloatField("Round Fade-in Duration:", globalInfo.gameGUI.roundFadeDuration));
                        ...
                        globalInfo.gameGUI.hasUltraGauge = EditorGUILayout.Toggle("Has Ultra Gauge/Meter", globalInfo.gameGUI.hasUltraGauge);
                        globalInfo.gameGUI.hasStunGauge = EditorGUILayout.Toggle("Has Stun Gauge/Meter", globalInfo.gameGUI.hasStunGauge);
            ...
            EditorGUILayout.BeginVertical(rootGroupStyle);
            {
                ...
                if (trainingModeOptions) {
                    EditorGUILayout.BeginVertical(subGroupStyle);
                    {
                        ...
                        globalInfo.trainingModeOptions.p1UltraGauge = (LifeBarTrainingMode)EditorGUILayout.EnumPopup("Player 1 Ultra Gauge:", globalInfo.trainingModeOptions.p1UltraGauge, enumStyle);
                        globalInfo.trainingModeOptions.p2UltraGauge = (LifeBarTrainingMode)EditorGUILayout.EnumPopup("Player 2 Ultra Gauge:", globalInfo.trainingModeOptions.p2UltraGauge, enumStyle);
                        globalInfo.trainingModeOptions.p1StunGauge = (LifeBarTrainingMode)EditorGUILayout.EnumPopup("Player 1 Stun Gauge:", globalInfo.trainingModeOptions.p1StunGauge, enumStyle);
                        globalInfo.trainingModeOptions.p2StunGauge = (LifeBarTrainingMode)EditorGUILayout.EnumPopup("Player 2 Stun Gauge:", globalInfo.trainingModeOptions.p2StunGauge, enumStyle);
			...
			EditorGUILayout.BeginVertical(rootGroupStyle);{
				...
				if (advancedOptions){
					EditorGUILayout.BeginVertical(subGroupStyle);{
                        ...
                        globalInfo.stunStandupTime = EditorGUILayout.FloatField("Global stun stand up time :", globalInfo.stunStandupTime);
                        globalInfo.stunDelayStartTime = EditorGUILayout.FloatField("Global stun delay start time :", globalInfo.stunDelayStartTime);
                        globalInfo.stunDecreaseSpeed = EditorGUILayout.FloatField("Global stun decrease speed:", globalInfo.stunDecreaseSpeed);
		...
		if (Application.dataPath.Contains("LocalAssets/UFE/UFE Package")
            || Application.dataPath.Contains("LocalAssets/UFE/UFE PRO")
            || Application.dataPath.Contains("LocalAssets/UFE/UFE Basic")) {
		...
		if (option.editorToggle){
			EditorGUILayout.BeginVertical(subGroupStyle);{
                ...
                if (label == "Crumple Knockdown"){
                    ...
                    if (label == "Mid Knockdown" || label == "High Knockdown" || label == "Sweep Knockdown")
                        option.overrideAirAnimation = EditorGUILayout.Toggle("Override Air Animation", option.overrideAirAnimation);
...
//					battles[i].conversationAfterBattle = (StoryModeScreen) EditorGUILayout.ObjectField("After the battle:", battles[i].conversationAfterBattle, typeof(StoryModeScreen), true);
	...
	private Vector2 ReturnRange(CharacterDistance distance, int size){
		...
		if (size == 2){
			...
			if ((int)distance == (int)CharacterDistance.Far) return new Vector2(61, 80);
